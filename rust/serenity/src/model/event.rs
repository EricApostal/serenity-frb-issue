...
pub struct MessageUpdateEvent {
    ...
    pub webhook_id: Option<Box<Option<WebhookId>>>,
    #[serde(rename = "type")]
    pub kind: Option<MessageType>,
    #[serde(default, deserialize_with = "deserialize_some")]
    pub activity: Option<Box<Option<MessageActivity>>>,
    #[serde(default, deserialize_with = "deserialize_some")]
    pub application: Option<Box<Option<MessageApplication>>>,
    #[serde(default, deserialize_with = "deserialize_some")]
    pub application_id: Option<Box<Option<ApplicationId>>>,
    pub message_reference: Option<Box<Option<MessageReference>>>,
    #[serde(default, deserialize_with = "deserialize_some")]
    pub flags: Option<Box<Option<MessageFlags>>>,
    #[serde(default, deserialize_with = "deserialize_some")]
    pub referenced_message: Option<Box<Option<Box<Message>>>>,
    #[cfg_attr(not(ignore_serenity_deprecated), deprecated = "Use interaction_metadata")]
    #[serde(default, deserialize_with = "deserialize_some")]
    pub interaction: Option<Box<Option<Box<MessageInteraction>>>>,
    pub interaction_metadata: Option<Box<Option<Box<MessageInteractionMetadata>>>>,
    #[serde(default, deserialize_with = "deserialize_some")]
    pub thread: Option<Box<Option<GuildChannel>>>,
    pub components: Option<Vec<ActionRow>>,
    pub sticker_items: Option<Vec<StickerItem>>,
    pub position: Option<Box<Option<u64>>>,
    pub role_subscription_data: Option<Box<Option<RoleSubscriptionData>>>,
    pub guild_id: Option<GuildId>,
    pub member: Option<Box<Option<Box<PartialMember>>>>,
}
