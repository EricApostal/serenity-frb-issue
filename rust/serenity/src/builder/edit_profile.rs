...
pub struct EditProfile {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    avatar: Option<Box<Option<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
