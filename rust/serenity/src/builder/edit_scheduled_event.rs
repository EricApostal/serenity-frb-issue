...
pub struct EditScheduledEvent<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    entity_metadata: Option<Box<Option<ScheduledEventMetadata>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    name: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl<'a> EditScheduledEvent<'a> {
    ...
    pub fn kind(mut self, kind: ScheduledEventType) -> Self {
        if let ScheduledEventType::External = kind {
            ...
            self.entity_metadata = Some(None.into());
        }
    ...
    pub fn location(mut self, location: impl Into<String>) -> Self {
        self.entity_metadata =
            Some(Some(ScheduledEventMetadata { location: Some(location.into()) }).into());
        self
    }
