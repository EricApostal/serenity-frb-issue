...
pub struct EditGuild<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    default_message_notifications: Option<Box<Option<DefaultMessageNotificationLevel>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    explicit_content_filter: Option<Box<Option<ExplicitContentFilter>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    afk_channel_id: Option<Box<Option<ChannelId>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    afk_timeout: Option<AfkTimeout>,
    #[serde(skip_serializing_if = "Option::is_none")]
    icon: Option<Box<Option<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    owner_id: Option<UserId>,
    #[serde(skip_serializing_if = "Option::is_none")]
    splash: Option<Box<Option<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    discovery_splash: Option<Box<Option<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    banner: Option<Box<Option<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    system_channel_id: Option<Box<Option<ChannelId>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    system_channel_flags: Option<SystemChannelFlags>,
    #[serde(skip_serializing_if = "Option::is_none")]
    rules_channel_id: Option<Box<Option<ChannelId>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    public_updates_channel_id: Option<Box<Option<ChannelId>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    preferred_locale: Option<Box<Option<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl<'a> EditGuild<'a> {
    ...
    pub fn afk_channel(mut self, channel: Option<ChannelId>) -> Self {
        self.afk_channel_id = Some(channel.into());
        self
    }
    ...
    pub fn discovery_splash(mut self, splash: Option<String>) -> Self {
        self.discovery_splash = Some(splash.into());
        self
    }
    ...
    pub fn system_channel_id(mut self, channel_id: Option<ChannelId>) -> Self {
        self.system_channel_id = Some(channel_id.into());
        self
    }
    ...
    pub fn rules_channel_id(mut self, channel_id: Option<ChannelId>) -> Self {
        self.rules_channel_id = Some(channel_id.into());
        self
    }
    ...
    pub fn public_updates_channel_id(mut self, channel_id: Option<ChannelId>) -> Self {
        self.public_updates_channel_id = Some(channel_id.into());
        self
    }
    ...
    pub fn explicit_content_filter(mut self, level: Option<ExplicitContentFilter>) -> Self {
        self.explicit_content_filter = Some(level.into());
        self
    }
    ...
    pub fn default_message_notifications(
        ...
        self.default_message_notifications = Some(level.into());
        self
    }
